...
in
{
  ...
  boot = {
    ...
    kernelModules = [ "vfio_pci" "vfio" "vfio_iommu_type1" ] ++ [ "bridge" "nft_chain_nat" ] ++ config.boot.initrd.availableKernelModules ++ config.boot.initrd.kernelModules; # See: https://github.com/triton/triton
